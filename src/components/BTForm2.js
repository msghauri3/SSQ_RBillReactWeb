...
function BTForm() {
  ...
  const backgroundStyle = {
    backgroundImage: 'url(/slider01.png)',
  ...
  return (
    <div className="bt-form-wrapper" style={backgroundStyle}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div className="column-3">
          <div className="image-card">
            <img src="/slider01.jpg" alt="Bill" className="image-display" />
          </div>
        </div>
      </div>
    </div>
